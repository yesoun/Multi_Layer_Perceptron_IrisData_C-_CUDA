...
main_mlp_cuda.o:main_mlp_cuda.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

MLP.o:MLP.cpp
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

main_mlp_cuda: main_mlp_cuda.o MLP.o
...
clean:
	rm -f main_mlp_cuda main_mlp_cuda.o MLP.o main.o
	rm -rf ../../bin/$(OS_ARCH)/$(OSLOWER)/$(TARGET)$(if $(abi),/$(abi))/main_mlp_cuda
